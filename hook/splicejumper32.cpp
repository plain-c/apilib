...
{ 
  ...
  */
  ...
  /**
   * Прототип бинарного кода переключателя для 32-битного окружения.
  */
  static const splicejumper_bincode_t SPLICEJUMPER_BINCODE_PROTOTYPE =
  {
    ...
    {0xB9,0x00000000},                   /// mov   ecx, splicejumper
    {0xB8,0x00000000},                   /// mov   eax, splicejumper_enter_bincode
    {0xFF,0xD0},                         /// call  eax
    ...
    0x60,                                /// pusha
    {0xB9,0x00000000},                   /// mov   ecx, splicejumper
    {0xB8,0x00000000},                   /// mov   eax, splicejumper_leave_bincode
    {0xFF,0xD0},                         /// call  eax
    {0x89,0x44,0x24,0x20},               /// mov   [esp+8*4], eax
    0x61,                                /// popa
    0xC3                                 /// retn
